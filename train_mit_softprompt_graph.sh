#!/bin/bash
#SBATCH --job-name=mit-softprompt-graph
#SBATCH --partition=gpu_mem
#SBATCH --gres=gpu:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=12:00:00
#SBATCH --output=logs/mit/train/SoftPT_Graph-%j.out
#SBATCH --error=logs/mit/train/SoftPT_Graph-%j.err
...
python train.py --cfg ${CONFIG} \
    ...
    TRAIN.checkpoint_dir       "checkpoints/mit/SoftPT_Graph/${SLURM_JOB_ID}" \
    TRAIN.log_dir              "tensorboards/mit/SoftPT_Graph/${SLURM_JOB_ID}" \
